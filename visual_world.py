...
def curated_demo_scenarios() -> List[ScenarioSpec]:
    ...
    return [
        ScenarioSpec(
            ...
            ego_speed_mps=12.8,
            lead=VehicleSpec(distance_m=20.0, speed_mps=5.6),
        ...
        # --- Expanded credibility scenarios (demo_08+) — varied gaps, weather, urgency ---
        ScenarioSpec(
            scenario_id="demo_08_urgent_wide_lead_pass",
            route=base_route,
            request=RequestSpec(text="I need to reach B very soon.", deadline_s=17.0),
            ego_speed_mps=12.6,
            lead=VehicleSpec(distance_m=38.0, speed_mps=5.0),
            rear=VehicleSpec(distance_m=110.0, speed_mps=9.2),
            oncoming=VehicleSpec(distance_m=275.0, speed_mps=9.8),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=205.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.06),
        ),
        ScenarioSpec(
            scenario_id="demo_09_oncoming_borderline_wait",
            route=base_route,
            request=RequestSpec(text="I am late, but do not drive unsafely.", deadline_s=19.0),
            ego_speed_mps=12.4,
            lead=VehicleSpec(distance_m=26.0, speed_mps=5.5),
            rear=VehicleSpec(distance_m=100.0, speed_mps=9.5),
            oncoming=VehicleSpec(distance_m=88.0, speed_mps=12.5),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=195.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.05),
        ),
        ScenarioSpec(
            scenario_id="demo_10_heavy_rain_occluded",
            route=base_route,
            request=RequestSpec(text="Need to arrive quickly through a visually blocked road.", deadline_s=22.0),
            ego_speed_mps=11.8,
            lead=VehicleSpec(distance_m=27.0, speed_mps=5.8),
            rear=VehicleSpec(distance_m=92.0, speed_mps=10.0),
            oncoming=VehicleSpec(distance_m=240.0, speed_mps=10.5),
            occlusion=OcclusionSpec(kind="parked_cars", severity=0.82, sight_distance_m=52.0),
            weather=WeatherSpec(rain=0.55, fog=0.35),
            sensor=SensorSpec(noise_std_m=0.18),
        ),
        ScenarioSpec(
            scenario_id="demo_11_fast_lead_convoy_pass",
            route=base_route,
            request=RequestSpec(text="I need to reach B very soon.", deadline_s=16.0),
            ego_speed_mps=12.9,
            lead=VehicleSpec(distance_m=22.0, speed_mps=8.8),
            rear=VehicleSpec(distance_m=115.0, speed_mps=9.0),
            oncoming=VehicleSpec(distance_m=310.0, speed_mps=9.5),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=200.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.05),
        ),
        ScenarioSpec(
            scenario_id="demo_12_tight_rear_closing",
            route=base_route,
            request=RequestSpec(text="I need to arrive quickly, but rear traffic is closing.", deadline_s=21.0),
            ego_speed_mps=12.1,
            lead=VehicleSpec(distance_m=24.0, speed_mps=5.6),
            rear=VehicleSpec(distance_m=28.0, speed_mps=14.5),
            oncoming=VehicleSpec(distance_m=260.0, speed_mps=9.5),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=205.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.05),
        ),
        ScenarioSpec(
            scenario_id="demo_13_dense_fog_selective_pass",
            route=base_route,
            request=RequestSpec(text="Try to arrive on time if there is a safe opening.", deadline_s=24.0),
            ego_speed_mps=11.5,
            lead=VehicleSpec(distance_m=30.0, speed_mps=6.0),
            rear=VehicleSpec(distance_m=98.0, speed_mps=10.0),
            oncoming=VehicleSpec(distance_m=255.0, speed_mps=10.0),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=120.0),
            weather=WeatherSpec(fog=0.52, rain=0.10),
            sensor=SensorSpec(noise_std_m=0.12),
        ),
        ScenarioSpec(
            scenario_id="demo_14_noisy_sensors_safe_pass",
            route=base_route,
            request=RequestSpec(text="I need to reach B very soon.", deadline_s=18.0),
            ego_speed_mps=12.4,
            lead=VehicleSpec(distance_m=34.0, speed_mps=5.4),
            rear=VehicleSpec(distance_m=108.0, speed_mps=9.8),
            oncoming=VehicleSpec(distance_m=285.0, speed_mps=9.2),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=190.0),
            weather=WeatherSpec(rain=0.08),
            sensor=SensorSpec(noise_std_m=0.28),
        ),
        ScenarioSpec(
            scenario_id="demo_15_extreme_deadline_pass",
            route=base_route,
            request=RequestSpec(text="I need to reach B immediately.", deadline_s=12.0),
            ego_speed_mps=13.0,
            lead=VehicleSpec(distance_m=28.0, speed_mps=5.2),
            rear=VehicleSpec(distance_m=125.0, speed_mps=8.8),
            oncoming=VehicleSpec(distance_m=300.0, speed_mps=9.0),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=210.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.05),
        ),
        ScenarioSpec(
            scenario_id="demo_16_crawler_lead_urgent",
            route=base_route,
            request=RequestSpec(text="I need to reach B very soon.", deadline_s=15.0),
            ego_speed_mps=12.7,
            lead=VehicleSpec(distance_m=36.0, speed_mps=3.8),
            rear=VehicleSpec(distance_m=102.0, speed_mps=9.5),
            oncoming=VehicleSpec(distance_m=295.0, speed_mps=9.5),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=200.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.06),
        ),
        ScenarioSpec(
            scenario_id="demo_17_medium_urgency_balanced",
            route=base_route,
            request=RequestSpec(text="Try to reach B on time if safe.", deadline_s=28.0),
            ego_speed_mps=12.0,
            lead=VehicleSpec(distance_m=31.0, speed_mps=6.5),
            rear=VehicleSpec(distance_m=88.0, speed_mps=10.5),
            oncoming=VehicleSpec(distance_m=220.0, speed_mps=10.5),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=175.0),
            weather=WeatherSpec(rain=0.12, fog=0.08),
            sensor=SensorSpec(noise_std_m=0.10),
        ),
        ScenarioSpec(
            scenario_id="demo_18_oncoming_far_confident_pass",
            route=base_route,
            request=RequestSpec(text="I need to reach B very soon.", deadline_s=18.0),
            ego_speed_mps=12.5,
            lead=VehicleSpec(distance_m=26.0, speed_mps=5.7),
            rear=VehicleSpec(distance_m=118.0, speed_mps=9.0),
            oncoming=VehicleSpec(distance_m=340.0, speed_mps=8.8),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=215.0),
            weather=WeatherSpec(sun_angle_deg=12.0),
            sensor=SensorSpec(noise_std_m=0.05),
        ),
        ScenarioSpec(
            scenario_id="demo_19_wet_highway_pass",
            route=base_route,
            request=RequestSpec(text="Try to arrive on time if there is a safe opening.", deadline_s=23.0),
            ego_speed_mps=12.2,
            lead=VehicleSpec(distance_m=29.0, speed_mps=6.0),
            rear=VehicleSpec(distance_m=95.0, speed_mps=10.0),
            oncoming=VehicleSpec(distance_m=250.0, speed_mps=10.0),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=180.0),
            weather=WeatherSpec(rain=0.42, fog=0.12),
            sensor=SensorSpec(noise_std_m=0.14),
        ),
        ScenarioSpec(
            scenario_id="demo_20_rear_distant_safe_pass",
            route=base_route,
            request=RequestSpec(text="I need to reach B very soon.", deadline_s=17.0),
            ego_speed_mps=12.6,
            lead=VehicleSpec(distance_m=33.0, speed_mps=5.5),
            rear=VehicleSpec(distance_m=145.0, speed_mps=8.5),
            oncoming=VehicleSpec(distance_m=280.0, speed_mps=9.8),
            occlusion=OcclusionSpec(kind="none", severity=0.0, sight_distance_m=205.0),
            weather=WeatherSpec(),
            sensor=SensorSpec(noise_std_m=0.05),
        ),
        ScenarioSpec(
            scenario_id="demo_21_partial_occlusion_replan",
            route=base_route,
            request=RequestSpec(text="Need to arrive quickly through a visually blocked road.", deadline_s=26.0),
            ego_speed_mps=11.9,
            lead=VehicleSpec(distance_m=27.0, speed_mps=6.1),
            rear=VehicleSpec(distance_m=90.0, speed_mps=10.2),
            oncoming=VehicleSpec(distance_m=235.0, speed_mps=10.2),
            occlusion=OcclusionSpec(kind="parked_cars", severity=0.58, sight_distance_m=72.0),
            weather=WeatherSpec(rain=0.18, fog=0.22),
            sensor=SensorSpec(noise_std_m=0.16),
        ),
    ]
