...
for i, e in enumerate(execs):
    ...
    print(
        ...
        f"pass_head={fb.get('passing_heading_error_deg')} "
        f"trav_head={fb.get('travel_heading_error_deg')} "
        ...
        f"commit={fb.get('pass_corridor_committed')} "
        f"peak={fb.get('pass_peak_shift_m')} "
        f"lead_gap={fb.get('lead_longitudinal_gap_m')} "
        f"ego_s={fb.get('ego_s_m')} "
        f"lead_s={fb.get('lead_s_m')} "
